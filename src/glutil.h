...
#	define M_PI 3.14159265358979323846f
    ...
    */
    glm::mat4x4 perspectiveMatrix(float fov, float aspectRatio, float n, float f);

    /* LookAt Matrix
    *
    * TBD
    */
    glm::mat4x4 lookAt(const glm::vec3 &eyePosition, const glm::vec3 &lookAt, const glm::vec3 &desiredUp);
...
#	define __debugbreak() assert(false)
    ...
    */
    void setUniformSlow(GLuint shaderProgram, const char *name, const glm::mat4x4 &matrix);
    ...
    * can be pretty handy.
    */
    void debugDrawLight(const glm::mat4x4 &viewMatrix,
